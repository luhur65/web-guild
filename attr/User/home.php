...
<div class="mx-auto">
    ...
    ?>
        ...
        <div class="mx-auto">
            ...
            <?php else : ?>
                <a href="?mod=viewUser&q=<?= base64_encode($p['full_name'])?>" class="h6"><?= $nama[0] . " " . $nama[1]; ?> ...</a>
            <?php endif ?>
          ...
          &raquo;<a href="?mod=viewMyGuildID&idGuild=<?= base64_encode($p['id_guild']); ?>" class="mx-2 font-weight-bold"><?= $p['guild_name']; ?></a>
                ...
                <div class="card-body">
                  ...
                  <p class="lead">
                    <?php if(strlen($p['post']) > 900) :?>
                      <?= substr($p['post'],0,900); ?> ... <a href="?mod=seeMore&data=<?= base64_encode($p['id_post']) ?>" class="btn btn-link">Lihat Selengkapnya</a>
                      <?php else : ?>
                      <?= $p['post']; ?>
                      <?php endif ?>
                  </p>
