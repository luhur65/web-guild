        ...
        <div class="row justify-content-center">
          <div class="col-lg-7">
            <div class="card bg-secondary shadow border-3">
              ...
              <div class="card-body px-lg-5 py-lg-5">
                <div class="text-muted mb-4">
                  <small>Use Your Nickname Or Email Address</small>
                ...
                <form action="" method="POST" class="user">
                  <div class="form-group mb-3">
                    <div class="input-group input-group-alternative">
                      ...
                      <input class="form-control" placeholder="Email Address Or Nickname" type="text" name="username" required autocomplete="off" autofocus>
                    </div>
                  </div>
            ...
            <div class="row mt-3">
              ...
              <div class="col-6">
                <a href="<?= base_url; ?>/attr/register" class="text-white"><small>Daftar Akun Baru</small></a>
              </div>
            </div>
          </div>
        </div>
