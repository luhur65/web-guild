...
<div id="wrapper">
  <!-- Sidebar -->
  <ul class="navbar-main navbar-nav bg-gradient-dark sidebar sidebar-dark accordion navbar-dark" id="accordionSidebar">
    <!-- Sidebar - Brand -->
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <!-- Nav Item - Alerts -->
                  ...
                  <?php foreach($arrayReport as $ar) : ?>
                    <?php if($ar['is_receive'] === '0') :?>
                  <a class="dropdown-item d-flex align-items-center" href="?mod=seeDetail&data=<?= base64_encode($ar['id_report']); ?>">
										<div class="dropdown-list-image mr-3">
											<img class="rounded-circle img-anggota img-fluid img-responsive" src="<?= base_url; ?>/assets/img/user-icon/<?= $ar['foto_profil']; ?>" alt="Profil">
										</div>
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="?mod=read&data=<?= base64_encode($ale['id_feedback']); ?>">
                  <div class="mr-3">
                ...
                <?php endforeach ?>
                <a class="dropdown-item text-center small text-danger btn btn-link" href="?mod=deleteAllNotif&data-user=<?= $alert['user_id']; ?>"><i class="fas fa-trash-alt fa-fw"></i> Hapus Semua Pesan</a>
                <?php endif ?>
              </div>
            </li>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="../../assets/img/user-icon/<?= $detail['foto_profil'] ?>" alt="Profil Saya">
              </a>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?= base_url; ?>/attr/auth_out" data-toggle="modal" data-target="#logoutModal">
